...
**Важно:** Если у вас УЖЕ есть зарегистрированные пользователи, обязательно выполните миграцию `002_backfill_existing_users.sql` - она создаст профили для всех существующих пользователей.
